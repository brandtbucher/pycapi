...
PyCAPI is a Python package containing over 600 fast bindings to the CPython C API. Its goal is to support as much of the Python 3.7 - 3.10 stable public APIs as possible.
